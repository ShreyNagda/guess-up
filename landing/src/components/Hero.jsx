...
export const Hero = () => {
  ...
  return (
    <section
      className="relative pt-6 pb-8 sm:pt-14 sm:pb-16 md:pt-20 md:pb-24 overflow-hidden"
      id="hero"
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center gap-6 sm:gap-10 relative z-10">
        {/* Top Badge */}
        <motion.div
          initial={{ opacity: 0, y: -15 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4 }}
          className="inline-flex items-center gap-2 bg-primary/10 border border-primary/30 text-primary px-3.5 py-1 sm:px-4 sm:py-1.5 rounded-full font-black text-[0.65rem] sm:text-xs uppercase tracking-widest backdrop-blur-md shadow-sm"
        >
          <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary" /> THE #1
          AD-FREE PARTY CHARADES GAME FOR INDIA
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-col items-center gap-3 sm:gap-5 max-w-3xl"
        >
          ...
          <p className="text-muted text-xs sm:text-sm max-w-xl leading-relaxed">
            Curated Desi pop-culture decks, 60 FPS motion sensing, 2-team battle
            mode, and 100% uninterrupted game flow.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto mt-2">
            ...
            >
              <Play className="w-4 h-4 fill-primary text-primary" /> Try Live
              Interactive Demo
            </button>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-[0.7rem] text-muted font-bold mt-1">
            ...
            <span>
              100% Free • No Credit Card Required • Official Google Play Closed
              Beta Access
            </span>
          </div>
        </motion.div>
