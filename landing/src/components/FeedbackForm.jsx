...
export const FeedbackForm = () => {
  ...
  const [deviceType] = useState("Android");
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name.trim() || !email.trim() || !feedbackText.trim()) {
      setError(
        "Please fill out your name, email address, and feedback details.",
      );
      return;
    }
    setError("");
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="bg-surface/80 border border-border/60 backdrop-blur-md p-5 sm:p-12 rounded-2xl sm:rounded-3xl shadow-card shadow-card-hover flex flex-col gap-6 sm:gap-8">
          <div className="text-center max-w-xl mx-auto flex flex-col gap-2">
            ...
            <p className="text-muted text-xs sm:text-sm">
              Found a bug, have a deck suggestion, or want to share your
              experience? We read every single message.
            </p>
          </div>
          ...
          {submitted ? (
            ...
            >
              ...
              <p className="text-muted text-xs max-w-md leading-relaxed">
                Thank you, <strong>{name}</strong>! Your notes have been sent to
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3.5 rounded-2xl bg-surface-card border border-border/80 text-xs font-semibold outline-none transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-3.5 rounded-2xl bg-surface-card border border-border/80 text-xs font-semibold outline-none transition-all appearance-none"
                  >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-2xl bg-surface-card border border-border/80 text-xs font-semibold outline-none transition-all resize-none"
                />
              </div>
